 ...
 * 
 * Implementation: SeedFlexible.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * Implementation: SeedRolling.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * Implementation: SeedCounterCyclical.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * Implementation: SeedYieldSplit.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 * VARIANT 8: INSURANCE SEED
 * ───────────────────────────────────────────────────────────────────────────────
 * @dev Seed acts as insurance pool, can pay out during black swan events.
 * 
 * Parameters:
 * - seedPercent: Percentage locked per transaction
 * - claimTriggers: Conditions that enable claims
 ...
 * 
 * Behaviour:
 * - Seed accumulates as insurance reserve
 ...
 * 
 * Use Cases: DeFi insurance, protocol protection, user safety nets
 * 
 * Implementation: SeedInsurance.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * Implementation: SeedBurning.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * Implementation: SeedTimeDecay.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * Implementation: SeedMatched.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * Implementation: SeedGovernance.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * Implementation: SeedCompoundOnly.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * Implementation: SeedEmergencyRelease.sol
 *
 * ───────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * Implementation: SeedCharitable.sol
 *
 * ═══════════════════════════════════════════════════════════════════════════════
 ...
 */
interface ISeed {
    /// @notice Returns current seed balance
    function getSeedBalance() external view returns (uint256);
...
contract SeedEngine is ISeed, ReentrancyGuard, Ownable {
    ...
    /// @inheritdoc ISeed
    function isLocked() external view returns (bool) {
        (bool dormant,) = this.getDormancyStatus();
        return !dormant;
    }
    ...
    function dormancyWithdraw(address to, uint256 amount) external nonReentrant onlyOwner {
        (bool isDormant,) = this.getDormancyStatus();
        require(isDormant, "System not dormant");
        require(amount <= seedBalance, "Insufficient seed");
